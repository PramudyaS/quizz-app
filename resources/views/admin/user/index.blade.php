        ...
        <div class="bg-white pb-4 px-4 rounded-md w-full mt-5">
            <div class="flex justify-between w-full pt-6">
                <div class="flex-inline">
                    <h3 class="font-medium text-2xl">Users</h3>
                    <p class="text-sm">Show all list user</p>
                </div>
                <div class="w-28">
                    <a class="bg-purple-600 px-3 py-2 text-white rounded-md float-right" href="{{  route
                    ('user.create')  }}">Create</a>
                </div>
            </div>
            ...
            <div class="overflow-x-auto mt-6">
                <table class="table-auto border-collapse w-full">
                    ...
                    <tr class="rounded-lg text-sm font-medium text-gray-700 text-left" style="font-size: 0.9674rem">
                        ...
                        <th class="px-4 py-2 bg-gray-200">Role</th>
                    ...
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
                            ...
                            <td class="px-4 py-4 text-white">
                                ...
                                <a href="{{  route('user.edit',$user->id)  }}" class="bg-green-500 px-2
