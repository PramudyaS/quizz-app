                            ...
                            <div class="relative mt-2">
                                <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    ...
                                    @foreach($question_categories as $category)
                                        <option value="{{  $category->id  }}" {{  $question->question_category_id ===
                                         $category->id ? 'checked' : ''
                                        }}>{{  $category->name
                                        }}</option>
                                    @endforeach
                            ...
                            <div class="w-full mt-2">
                                <div class="inline">
                                    ...
                                    bg-contain float-left mr-2 cursor-pointer"
                                             type="radio"
                                             name="right_answer" value="A" {{  $question->correct_answer == 'A' ?
                                             'checked' : null
                                               }}>
                                    <input type="text" name="answer_text[A]"
                                           value="{{  $question_answers->A  }}"
                                           class="w-1/2
                                    bg-slate-200
                                    rounded
                            ...
                            <div class="w-full mt-2">
                                <div class="inline">
                                    ...
                                    border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                             type="radio"
                                             name="right_answer" value="B" {{  $question->correct_answer == 'B' ?
                                             'checked' : null
                                               }}>
                                    <input type="text" name="answer_text[B]"
                                           value="{{  $question_answers->B  }}"
                                           class="w-1/2 bg-slate-200 rounded
                                    border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
                                </div>
                            </div>
                            <div class="w-full mt-2">
                                <div class="inline">
                                    ...
                                    border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                             ...
                                             name="right_answer">
                                    <input type="text" name="answer_text[C]"
                                           value="{{  $question_answers->C  }}"
                                           class="w-1/2 bg-slate-200 rounded
                                    border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
                                </div>
                            </div>
                                ...
                                <div class="inline">
                                    ...
                                    border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                            ...
                                            'checked' : null
                                             ...
                                             name="right_answer">
                                    <input type="text" name="answer_text[D]"
                                           value="{{  $question_answers->D  }}"
                                           class="w-1/2 bg-slate-200 rounded
                                    border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
                                </div>
                            </div>
